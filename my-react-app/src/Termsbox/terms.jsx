...
function Terms(){
    return(
        <div className='term'>
          <h2 id="term1"> Terms and Conditions</h2>
          <p id="term2">Your Agreement</p>
          <div id="term3">
...
<p>3. LINKED SITES</p>
<p>This Site may contain links to other independent third-party Web sites ("Linked Sites”). These Linked Sites are provided solely as a convenience to our visitors. Such Linked Sites are not under our control, and we are not responsible for and doorse the content of such Linked Sites, including any information or materials contained on such Linked Sites. You will need to make your own independent judgment regarding your interaction with these Linked Sites.</p>
...
<div id="term7">
<p id="term4">I confirm that I have read and accept the terms and conditions and privacy policy.</p>
<button id="term5">Cancle</button>
<button id="term6">Accept</button></div>
 </div>
    )
}
